...
<div class="container" style="top: -200">
        <h2 style="color: red">Edit <span style="color: #fff">Profile</span>  </h2>
          <hr>
        <div class="row">
          <!-- left column -->
...
<br><br><br>       </div>
          ...
          <!-- edit form column -->
          <div class=" text col-lg-6 order-2 order-lg-2 personal-info myFont " style="color: #ffffff">
            <!--  <div class="alert alert-info alert-dismissable myFont">
