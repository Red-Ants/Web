...
<br>
<br>      
     <div style="right: px" >    <h3 style="color: white"> <strong style="color: red">FACULTY</strong>REGISTRATION</h3></div>
<br>
	<form class="login100-form validate-form" name="regfaculty" onsubmit="return check()">
